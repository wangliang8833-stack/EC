...
基于 Electron、React 和 TypeScript 的多账号隔离电商数据采集与本地报表平台。当前处于阶段 0：拼多多技术 PoC。
...
- 销售总览从本地 Report Dataset 展示真实昨日指标、商品、来源、搜索词、客服和数据覆盖警告；
...
详细范围、排期和状态见 [开发计划.md](./开发计划.md)、[任务日志.md](./任务日志.md) 和 [每日总结.md](./每日总结.md)。
